...
- Pick ONE of the following built-in JavaScript string functions, look it up online and read about it, and then write one of your blog posts explaining what it does and why it’s useful. Write at least 3 short code examples of your own that show how to use it, and include the same code on your blog. (Bonus: format your code examples with syntax highligting, following GitHub’s Markdown Cheatsheet here: https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)
